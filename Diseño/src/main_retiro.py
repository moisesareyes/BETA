...
def main_ret (page: ft.Page):
    ...
    page.bgcolor="#ffe3e8"
    rec=ft.CupertinoButton(content=ft.Text("RETIRAR BS.D",color="WHITE",font_family="Berlin Sans FB"),bgcolor="#c4394d",width=300)
    ...
    mybar = ft.BottomAppBar(
        ...
        content=ft.Row(
            controls=[
                ...
                ft.IconButton(icon=ft.icons.TRENDING_UP_OUTLINED,icon_color="WHITE",bgcolor="#ff6178"),
