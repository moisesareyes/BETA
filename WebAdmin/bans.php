    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    <div class="card-body">
                        <h2 class="text-center">Baneos y suspensiones</h2>
                        <p class="text-danger">Si algún usuario incumple algún término o condición de Ma Pay, será suspendido o baneado del servicio dependiendo de la gravedad.</p>
                        <form action="banned.php" method="post">
                            ...
                            <div class="form-group">
                                <label for="banTime">Duración del Baneo:</label>
                                <select class="form-control" id="banTime" name="banTime" required>
